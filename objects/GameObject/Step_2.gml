...
if room = Level_Feild {
 ...
 if layer_exists(layer_get_id("Bg_still2"))
 {
 layer_x(layer_get_id("Bg_still2"),camera_get_view_x(view_camera[0]));
 ...
 if room = Level_Fantasy4 or room = Level_Fantasy5 {
	 layer_y(layer_get_id("Bg_1"), camera_get_view_y(view_camera[0]));
 }
